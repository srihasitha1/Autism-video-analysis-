...
def run_training() -> None:
    ...
    enc_path = output_path(CONFIG, CONFIG["encoder_save_path"])
    ...
    print(f"  Confusion    → {output_path(CONFIG, 'confusion_matrix_final.png')}")
    print("═" * 65)
...
def run_inference(video_path: str) -> None:
    ...
    model_candidates = [
        output_path(CONFIG, CONFIG["final_save_name"]),
        output_path(CONFIG, CONFIG["swa_save_name"]),
        output_path(CONFIG, CONFIG["phase2_save_name"]),
        output_path(CONFIG, CONFIG["phase1_save_name"]),
    ]
    enc_path = output_path(CONFIG, CONFIG["encoder_save_path"])
